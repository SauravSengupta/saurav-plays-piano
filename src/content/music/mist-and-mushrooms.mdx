...
import coverImage from '../../assets/images/mist-and-mushrooms-cover.jpg';

<TrackMedia youtubeUrl={frontmatter.youtubeUrl} image={{ src: coverImage }} alt="Mist & Mushrooms" />

### Listen Now

<ReleaseStreamingLinks releaseId="mist-and-mushrooms" />
